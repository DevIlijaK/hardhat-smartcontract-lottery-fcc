...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    bool private isOpen;
    bool private timePassed;
    bool private hasPlayers;
    bool private hasBalance;
    ...
    constructor(
        address crfCoordinatorV2,
        uint256 entranceFee,
        bytes32 gasLane,
        uint64 subscriptionId,
        uint32 callbackGasLimit,
        uint256 interval
    ) VRFConsumerBaseV2(crfCoordinatorV2) {
        i_entranceFee = entranceFee;
        i_vRFCoordinator = VRFCoordinatorV2Interface(crfCoordinatorV2);
        i_gasLane = gasLane;
    ...
    function enterRaffle() public payable {
        //requeire msg.value > i_entranceFee
    ...
    function getHasPlayers() public view returns (bool) {
        return hasPlayers;
    }
